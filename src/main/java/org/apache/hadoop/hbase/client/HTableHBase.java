 ...
 */
public class HTableHBase implements AbstractHTableInterface {
   ...
   */
  @Deprecated
  public HTableHBase(final String tableName)
  throws IOException {
   ...
   */
  @Deprecated
  public HTableHBase(final byte [] tableName)
  throws IOException {
   ...
   * @throws IOException if a remote or network exception occurs
   */
  public HTableHBase(Configuration conf, final String tableName)
  throws IOException {
   ...
   * @throws IOException if a remote or network exception occurs
   */
  public HTableHBase(Configuration conf, final byte [] tableName)
  throws IOException {
   ...
   * @throws IOException if a remote or network exception occurs
   */
  public HTableHBase(final byte[] tableName, final HConnection connection,
   ...
   */
  @Override
  public synchronized Object[] batch(final List<? extends Row> actions)
      throws InterruptedException, IOException {
  ...
  public Result append(Append append) throws IOException {
    throw new UnsupportedOperationException("append() not supported in HBase 0.92");
  }
  ...
  public void mutateRow(RowMutations rm) throws IOException {
    ...
    throw new UnsupportedOperationException("mutateRow() not supported in HBase 0.92");
  }
