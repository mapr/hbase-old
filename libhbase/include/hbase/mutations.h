 ...
 */
HBASE_API int32_t
hb_put_create(const byte_t *rowkey, const size_t rowkey_len,
    hb_put_t *put_ptr);
 ...
 */
HBASE_API int32_t
hb_delete_create(const byte_t *rowkey, const size_t rowkey_len,
 ...
 */
HBASE_API int32_t
hb_increment_create(const byte_t *rowkey, const size_t rowkey_len,
 ...
 */
HBASE_API int32_t
hb_append_create(const byte_t *rowkey, const size_t rowkey_len,
 ...
 */
HBASE_API int32_t
hb_mutation_set_namespace(hb_mutation_t mutation,
    const char *name_space, const size_t name_space_len);

/**
 * Sets the table name for the mutation.
 */
HBASE_API int32_t
hb_mutation_set_table(hb_mutation_t mutation,
    const char *table, size_t const table_len);
 ...
 */
HBASE_API int32_t
hb_mutation_set_bufferable(hb_mutation_t mutation,
 ...
 */
HBASE_API int32_t
hb_mutation_set_row(hb_mutation_t mutation,
    const byte_t *rowkey, const size_t rowkey_len);

/**
 * Sets the durability guarantees for the Mutation.
 */
HBASE_API int32_t
hb_mutation_set_durability(hb_mutation_t mutation,
 ...
 */
HBASE_API int32_t
hb_delete_add_column(hb_delete_t del,
    const byte_t *family, const size_t family_len,
    const byte_t *qualifier, const size_t qualifier_len,
    const int64_t timestamp);
 ...
 */
HBASE_API int32_t
hb_delete_set_timestamp(hb_delete_t del,
    const int64_t timestamp);
 ...
 */
HBASE_API int32_t
hb_increment_add_column(hb_increment_t incr,
    hb_cell_t *cell, int64_t amount);
 ...
 */
HBASE_API int32_t
hb_append_add_column(hb_append_t append,
    hb_cell_t *cell);
