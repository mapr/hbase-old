 ...
 */
HBASE_API int32_t
hb_get_set_namespace(hb_get_t get,
 ...
 */
HBASE_API int32_t
hb_get_set_row(hb_get_t get, const byte_t *rk, const size_t rk_len);
 ...
 */
HBASE_API int32_t
hb_get_add_column(hb_get_t get,
 ...
 */
HBASE_API int32_t
hb_get_set_filter(hb_get_t get, const char *filter);
 ...
 */
HBASE_API int32_t
hb_get_set_num_versions(hb_get_t get, const int32_t num_versions);
 ...
 */
HBASE_API int32_t
hb_get_set_timestamp(hb_get_t get, const int64_t ts);
 ...
 */
HBASE_API int32_t
hb_get_set_timerange(hb_get_t get,
    const int64_t min_ts, const int64_t max_ts);
